...
libraries("readxl","ggplot2","MASS","psych","here","heplots","ggseg","patchwork","knitr")
source("/Users/mvlombardo/Dropbox/GitHubRepos/utils/cohens_d.R")
...
p = ggseg(data = hcp_annot, mapping=aes(fill = area), position = "stacked", atlas = "glasser", show.legend = FALSE)
...
So now the moment of truth where the results are unveiled (drum roll please...).  Lets start by seeing if any regions were significant after FDR q<0.05 correction for a sex*diagnosis interaction.
